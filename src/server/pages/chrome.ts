...
function topBar(bazaarCatalogUrl: string, currentPage?: string): string {
  ...
  <nav>
    ...
    <a href="/feedback" class="keep">feedback</a>
...
function footer(bazaarCatalogUrl: string): string {
  ...
  <span><a href="/">home</a> \u00B7 <a href="/buy">buy credits</a> \u00B7 <a href="/feedback">feedback</a> \u00B7 <a href="/openapi.json">OpenAPI</a> \u00B7 <a href="${bazaarCatalogUrl}" target="_blank" rel="noopener">Bazaar</a> \u00B7 <a href="/icon.png">icon</a></span>
</div></div></footer>`;
}
