...
describe('x402 capture (v2 wire, mock facilitator, no chain)', () => {
  ...
  it('S4: GET /v1/x402/service returns the agent-discoverable catalog', async () => {
    ...
    expect(svc.paidEndpoints).toEqual([
      ...
      expect.objectContaining({ method: 'POST', path: '/v1/x402/analyze', priceUsdc: 0.01, atomicUnits: '10000' }),
      expect.objectContaining({ method: 'POST', path: '/v1/x402/analyze/batch', priceUsdc: 0.01, atomicUnits: '10000' }),
