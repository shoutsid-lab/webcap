...
```bash
# Create a watch (free)
curl -X POST https://nickname-trident-driveway.ngrok-free.dev/v1/watches \
...
curl -X POST "https://nickname-trident-driveway.ngrok-free.dev/v1/x402/watches/topup?watchId=<watch-id>" \
  -H 'content-type: application/json' \
...
response = requests.post(
    "https://nickname-trident-driveway.ngrok-free.dev/v1/x402/extract",
...
2. **Check the OpenAPI spec:**
   ```
   GET https://nickname-trident-driveway.ngrok-free.dev/openapi.json
   ```

3. **Read the documentation:**
   ```
   GET https://nickname-trident-driveway.ngrok-free.dev/v1/x402/service
   ```
