...
3. Copy the BODY below (starting from "# Building a Web Capture API...") into the editor
4. Add tags: `webdev`, `javascript`, `web3`, `api`
5. Publish
...
- Free preview: https://nickname-trident-driveway.ngrok-free.dev/v1/extract/preview?url=https://example.com/
